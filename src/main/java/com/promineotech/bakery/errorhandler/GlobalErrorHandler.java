package com.promineotech.bakery.errorhandler;
...
// What is happening here: Spring intercepts NoSuchElementException, it will call the method
// handleNoSuchElementException and then it will pass in the exception (NoSuchElementException e)
//return a get message function.
...
public class GlobalErrorHandler {
  ...
  private Map<String, Object> createExceptionMessage(Exception e, 
    ...
    return error;
    //returns empty map for right now
  }
}
